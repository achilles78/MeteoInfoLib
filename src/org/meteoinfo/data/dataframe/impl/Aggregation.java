...
public class Aggregation {
    ...
    private static Object name(final DataFrame df, final Object row, final Object stat) {
...
//    public static <V> DataFrame cov(final DataFrame df) {
//        DataFrame num = df.numeric();
